...
> = {
  ...
  "Science Fiction": { colSpan: "col-span-1 md:col-span-2 lg:col-span-2", rowSpan: "md:row-span-2", size: "lg", icon: "rocket_launch", subtitle: "Infinite possibilities beyond the stars." },
  ...
  Drama:             { colSpan: "col-span-1 md:col-span-2 lg:col-span-2", size: "md", subtitle: "Editor's Choice" },
  ...
  Documentary:       { colSpan: "col-span-1 md:col-span-3 lg:col-span-3", size: "md", subtitle: "Real stories, real people." },
  Romance:           { colSpan: "col-span-1 md:col-span-3 lg:col-span-3", size: "md", subtitle: "Love in all its forms." },
...
const fallbackImages: Record<string, string> = {
  "Science Fiction": "https://image.tmdb.org/t/p/w780/xJHokMbljvjADYdit5fK5VQsXEG.jpg",
  ...
  Documentary:       "https://image.tmdb.org/t/p/w780/xJHokMbljvjADYdit5fK5VQsXEG.jpg",
...
export default function GenresBentoGrid({ genres }: { genres: GenreWithImage[] }) {
